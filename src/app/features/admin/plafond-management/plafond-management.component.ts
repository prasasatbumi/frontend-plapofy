    ...
    <app-layout>
        <div class="space-y-6">
          <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              <h2 class="text-2xl font-bold text-gray-900">Loan Packages</h2>
                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="bg-gray-50 border-b border-gray-100 text-xs uppercase text-gray-500 font-semibold">
                            ...
                            <th class="px-6 py-4">Max Amount</th>
                    ...
                    <tbody class="divide-y divide-gray-100">
                        <tr *ngFor="let p of filteredPlafonds()" class="hover:bg-gray-50/50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-sm font-medium text-gray-700">
                                {{ p.minAmount | currency:'Rp ':'symbol':'1.0-0' }}
                            </td>
                            <td class="px-6 py-4 text-sm font-medium text-gray-700">
          ...
          <div *ngIf="isModalOpen()" class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
            <div class="bg-white rounded-3xl w-full max-w-2xl shadow-2xl max-h-[90vh] overflow-y-auto">
              <div class="p-6 border-b border-gray-100 flex justify-between items-center sticky top-0 bg-white z-10">
                <h3 class="text-xl font-bold text-gray-900">{{ editingPlafond() ? 'Edit Package: ' + editingPlafond()?.name : 'Create New Package' }}</h3>
                 ...
                 <div class="grid md:grid-cols-2 gap-4">
                   <div>
                      ...
                      <div class="relative">
                        ...
                        <input type="number" [(ngModel)]="editForm.minAmount" class="w-full pl-10 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none">
                      </div>
                   </div>
                   <div>
